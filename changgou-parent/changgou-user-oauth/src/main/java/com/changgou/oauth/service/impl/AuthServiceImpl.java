...
public class AuthServiceImpl implements AuthService {
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret) {
        ...
        path = "http://localhost:9001/oauth/token";
        //定义body
    ...
    public static void main(String[] args)  throws  Exception{
        byte[] decode = Base64.getDecoder().decode("Y2hhbmdnb3UyMzQyNDMyNDpjaGFuZ2dvdTMyNDMyNDMyNDI=");
        String s = new String(decode, "utf-8");
        System.out.println(s);

        //加密
        String s1 = Base64.getEncoder().encodeToString(new String("changgou23424324:changgou3243243242").getBytes());
